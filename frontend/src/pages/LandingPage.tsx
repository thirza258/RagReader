  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-cyan-500/30 overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <h1 className="text-5xl lg:text-7xl font-bold leading-tight text-white mb-10">
        ...
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <p className="text-lg text-slate-400 max-w-xl leading-relaxed">
              Upload your documents and let our system perform deep dense,
              sparse, or hybrid retrieval. Get detailed evaluations of the
              retrieved chunks, query, and answer with retrieval score,
              faithfulness score, and answer relevance.
            </p>

            <div className="p-1 bg-gradient-to-r from-slate-800 to-slate-900 rounded-xl border border-slate-700 shadow-2xl">
              <div className="bg-slate-950 rounded-lg p-4">
                <p className="mb-4 text-sm text-slate-400 font-medium uppercase tracking-wider">
                  Start Your Analysis
                </p>
            ...
            <div className="relative z-10 bg-slate-900 border border-slate-700 rounded-2xl p-4 shadow-2xl transform rotate-2 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-slate-800 p-4 rounded-lg border border-slate-700">
                  ...
                  <div className="text-white font-semibold">
                    What is the Battle of Surabaya?
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-slate-800 p-4 rounded-lg border border-slate-700">
                  ...
                  <div className="text-white font-semibold">
                    The Surabaya War (Battle of Surabaya, 1945) was a major
                    armed conflict between Indonesian nationalists and Allied
                    forces, marking a pivotal moment in Indonesia’s struggle for
                    independence.
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-slate-800/70 p-3 rounded-lg border border-slate-700 text-sm text-slate-300">
                    ...
                    The Battle of Surabaya occurred in November 1945 and
                    involved Indonesian militias resisting British-led Allied
                    troops.
                  </div>

                  <div className="bg-slate-800/70 p-3 rounded-lg border border-slate-700 text-sm text-slate-300">
                    <span className="text-cyan-400 font-mono">Chunk 2:</span>
                    The conflict resulted in heavy casualties and is
                    commemorated annually as Heroes’ Day in Indonesia.
                  </div>
                </div>
      ...
      <section className="border-y border-white/5 bg-slate-900/30 py-8">
        <div className="container mx-auto px-6 flex flex-wrap justify-center gap-12 grayscale opacity-50">
          ...
          <span className="text-xl font-bold text-white flex items-center gap-2">
            <Network className="w-5 h-5" /> LangChain
          </span>
          <span className="text-xl font-bold text-white flex items-center gap-2">
            <BrainCircuit className="w-5 h-5" /> OpenAI
          </span>
          <span className="text-xl font-bold text-white flex items-center gap-2">
            <Layers className="w-5 h-5" /> FAISS
          </span>
          <span className="text-xl font-bold text-white flex items-center gap-2">
            <Vote className="w-5 h-5" /> OpenRouter
          </span>
          <span className="text-xl font-bold text-white flex items-center gap-2">
            <Library className="w-5 h-5" /> HuggingFace
          </span>
        </div>
      </section>
          ...
          <div className="flex flex-col items-center space-y-6">
            ...
            <div className="flex justify-start w-full">
              <div className="max-w-md bg-slate-800 text-slate-100 p-4 rounded-2xl rounded-bl-md shadow-lg flex flex-col space-y-3">
                <span>
                  The Surabaya War, fought in November 1945, was a major battle
                  between Indonesian nationalists and British-Dutch forces in
                  Surabaya, Indonesia. It marked a critical point in the
                  Indonesian struggle for independence, with massive casualties
                  and showing the world Indonesia's resolve to fight for
                  freedom.
                </span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
            <Card>
              ...
              <p className="text-sm text-slate-400">
                Semantic search using high-dimensional vectors to capture
                context beyond exact keyword matches.
              </p>
            </Card>
            ...
            <Card>
              ...
              <p className="text-sm text-slate-400">
                Traditional BM25 keyword matching to ensure exact terms and
                specific entities aren't lost.
              </p>
            </Card>
